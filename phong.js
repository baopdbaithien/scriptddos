...
console.log('TLS-HTTPS : @duongngocphong0311');
console.log(`Target : ${parsedTarget.host} | Port : ${targetPort}`);
console.log(`Time : ${args.time.toString()}/300 Second`);
console.log(`Threads : ${args.threads.toString()}/256`);
console.log(`Rate : ${args.Rate.toString()}/1024`);
console.log(`Proxy : ${args.proxyFile} | ${proxies.length}`);
console.log(`User : ngocphong0311 | Expiry : 99/99/9999`);
console.log('Support : HTTP1.1/HTTP2/HTTP3/TLSv1.1/TLSv1.2/TLSv1.3');
  setTimeout(() => {
    process.exit(1);
  }, process.argv[3] * 1000);
